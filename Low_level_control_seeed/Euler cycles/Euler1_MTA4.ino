...
int8_t cycle3[] = {11,15,11,16,15,6,15,14,15,12,15,1,15,13,15,5,15,9,15,16,9,6,9,14,9,12,9,1,9,13,9,5,9,16,5,6,5,14,5,12,5,1,5,13,5,16,13,6,13,14,13,12,13,1,13,16,1,6,1,14,1,12,1,16,12,6,12,14,12,16,14,6,14,16,6,16}; /* If you want to use more than 2 cycles make sure to  also add variables
